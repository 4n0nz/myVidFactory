#!/usr/bin/env python3
# score_real etendu : corpus original + les 6 nouvelles videos t6.
# Metric bulk : par video, 4 frames ; +1 par frame avec exactement 1 detection conf>0.5 ;
# -0.5 par frame avec >1 detection (decoy).
import sys, os, cv2
...
srcs = [("6gtf","wk_test_6GtF"),("1x32","wk_test_1x32"),("ethx","wk_test_Ethx"),
        ...
        ("fkeh","wk_t6_FkEh"),("kor1","wk_t6_cDXq"),("kor2","wk_t6_ogiQ"),
        ("kor3","wk_t6_QUfG"),("j6qw","wk_t6_J6qw"),("eglv","wk_t6_eglV")]
...
print(" ".join(line))
print(f"SCORE {total} DET {det}/48")
